...
public class AnswersActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ANSWER_IS_TRUE = "com.example.day_01_catquiz.true_answer";
    public static final String EXTRA_ANSWER_INDEX = "com.example.day_01_catquiz.index_answer";
